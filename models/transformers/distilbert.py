"""
Transformer model: DistilBERT for sentiment analysis
"""
...
def train_distilbert(train_df, test_df, model_name="distilbert-base-uncased",
    ...
    # Training arguments
    output_dir = Path(__file__).parent.parent.parent / "results" / "models" / "distilbert"
    ...
    metrics = evaluate_model(
        ...
        save_path="results/metrics/distilbert.json"
    )
    
    # Save predictions
    save_predictions(y_test_pred, y_test, "distilbert")
...
if __name__ == "__main__":
    ...
    model, tokenizer, metrics = train_distilbert(train_df, test_df)
