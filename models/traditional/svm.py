"""
Traditional ML model: TF-IDF + SVM
"""
...
def train_svm(train_df, test_df, max_features=10000, C=1.0):
    """
    ...
    print("\nValidation Results:")
    evaluate_model(y_val, y_val_pred, "SVM (Validation)")
    ...
    metrics = evaluate_model(
        y_test, y_test_pred,
        "TF-IDF + SVM",
        save_path="results/metrics/svm.json"
    )
    
    # Save predictions
    save_predictions(y_test_pred, y_test, "svm")
    ...
    with open(model_dir / "svm_vectorizer.pkl", 'wb') as f:
...
if __name__ == "__main__":
    ...
    model, vectorizer, metrics = train_svm(train_df, test_df)
